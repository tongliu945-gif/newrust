...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "In order to control your Desktop remotely, you need to grant RustDesk \"Network Encryption\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant RustDesk \"Start Access\" permissions."),
        ...
        ("Screen Capture", "Start Access"),
        ("Input Control", "Network Encryption"),
        ("Audio Capture", "Audio capture"),
        ("Open System Setting", "Open system setting"),
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow RustDesk to use the \"Network Encryption\" service."),
